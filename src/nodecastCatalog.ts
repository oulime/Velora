 ...
 */
export function imageUrlForDisplay(href: string, cssDisplayWidth?: number): string {
  const raw = href.trim();
  const t = cssDisplayWidth ? tmdbImageUrlMatchDisplayWidth(raw, cssDisplayWidth) : raw;
